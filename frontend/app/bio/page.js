    ...
    <div className="bio">
      ...
      <div className="bio-content">
        ...
        <div className="epk-section">
          ...
          <p>
            He is actively writing with his songwriting team <a href="https://freemanoleary.com/" target="_blank" rel="noopener noreferrer">Freeman / O'Leary</a> and performing with his band <a href="https://stillspark.com/" target="_blank" rel="noopener noreferrer">Still Spark</a>.
          </p>
        </div>
      </div>
    </div>
